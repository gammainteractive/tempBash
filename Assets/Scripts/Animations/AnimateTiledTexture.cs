...
public class AnimateTiledTexture : MonoBehaviour
{
    ...
    public float _framesPerSecond = 30;            // Frames per second that you want to texture to play at
    ...
    protected bool _isPlaying = false;                // A flag to determine if the animation is currently playing
    ...
    public virtual IEnumerator IPlay()
    {
    ...
    public virtual void ChangeMaterial(Material newMaterial, bool newInstance = false)
    {
        if (newInstance)
        {
